...
const fallbackContent: LanguageContent = {
  ...
  announcement: {
    title: '園庭の木々も冬の訪れを感じ始めたようで、葉が緑から黄色へと色づき、秋の深まりを感じる季節となりました。',
    content: '子どもたちは、運動会に向けて日々の練習に励み、気持ちもどんどん高まり、お友達とのつながりも深め、自信へとつながってきています。当日は、温かいご声援をどうぞよろしくお願いいたします。',
    readMoreText: '続き',
